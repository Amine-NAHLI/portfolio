...
/**
 * Individual timeline event card — alternates left/right on desktop.
 */
const TimelineItem = ({
  event,
  index,
      ...
      >
        ...
        <motion.div
          ...
          className={cn(
            ...
            event.highlight
              ? "border-accent-cyan/40 shadow-[0_0_20px_rgba(6,182,212,0.08)]"
        ...
        <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-6 md:top-1/2 md:-translate-y-1/2 z-10">
          <motion.div
            ...
            className={cn(
              ...
              event.highlight
                ? "w-12 h-12 border-accent-cyan text-accent-cyan shadow-[0_0_15px_rgba(6,182,212,0.3)]"
                : "w-9 h-9 border-white/20 text-text-muted"
            )}
          >
            {event.year.slice(-2)}
          </motion.div>
          ...
          <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-white/5">
            <motion.div
              ...
              style={{
                ...
                height: "100%",
                background:
                  "linear-gradient(to bottom, #06b6d4, #6366f1, #a855f7)",
              }}
            />
          </div>

...
type SiteFooterProps = { locale: Locale; dictionary: Dictionary };
  ...
  return <footer className="border-t border-border bg-surface-subtle/65 py-12 sm:py-16">
    <Container>
      <div className="grid gap-10 border-b border-border pb-10 md:grid-cols-[1.4fr_.8fr_.8fr] md:gap-16">
        ...
        <div><h2 className="system-label text-text-muted">{dictionary.footer.elsewhere}</h2><ul className="mt-4 grid gap-2 text-sm text-text-secondary"><li><a className="footer-link inline-flex items-center gap-1" href={siteConfig.links.github} target="_blank" rel="noreferrer">GitHub <ArrowUpRight aria-hidden="true" className="size-3.5" /></a></li><li><a className="footer-link inline-flex items-center gap-1" href={siteConfig.links.linkedin} target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight aria-hidden="true" className="size-3.5" /></a></li><li><a className="footer-link inline-flex items-center gap-1" href={siteConfig.links.tryHackMe} target="_blank" rel="noreferrer">TryHackMe <ArrowUpRight aria-hidden="true" className="size-3.5" /></a></li></ul></div>
      </div>

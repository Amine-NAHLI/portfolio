  ...
  return (
    <section id="about" className="relative py-32 bg-transparent overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Simplified Header */}
        <div className="mb-20 flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-white/5 pb-10">
           <div className="space-y-2">
              <div className="flex items-center gap-3">
                 <div className="w-2 h-2 rounded-full bg-accent-cyan animate-pulse" />
                 <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-text-4">System_Access_v3.0</span>
              </div>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="lg:col-span-12">
              <div className="bg-bg-1/40 rounded-[2.5rem] border border-white/5 p-8 md:p-12 relative overflow-hidden group min-h-[400px] flex flex-col justify-center">
                  ...
                  >
                     <div className="space-y-4">
                        ...
                        <h3 className="text-4xl md:text-7xl font-black tracking-tighter leading-[1] text-text-1 uppercase">
                           Architecting <br /> <span className="text-text-4 italic">The Future.</span>
                        </h3>
                     </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pt-4">
                        {[
                          ...
                          <div key={item.label} className="space-y-1 border-l border-white/10 pl-6">
                     ...
                     <div className="flex flex-wrap gap-4 pt-4">
                        <div className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white/5 border border-white/5 font-mono text-[10px] text-text-3 uppercase tracking-widest">
